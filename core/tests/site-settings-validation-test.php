...
$GLOBALS['test_site_config'] = ['languages' => ['en', 'nl'], 'nimblybar' => ['side' => 'left']];
$arabic = ['languages' => ['en', 'nl', 'ar'], 'nimblybar' => ['side' => 'left']];
site_settings_validation_assert(site_settings_validate_config('.config', 'site', $arabic), 'Adding Arabic was rejected.');
site_settings_validation_assert($arabic['direction'] === ['en' => 'ltr', 'nl' => 'ltr', 'ar' => 'rtl'], 'Text direction was not filled in for every language.');
site_settings_validation_assert($arabic['nimblybar']['side'] === ['en' => 'left', 'nl' => 'left', 'ar' => 'right'], 'A new right-to-left language did not start with the sidebar on the right.');
$kept = ['languages' => ['en', 'nl'], 'direction' => ['en' => 'ltr', 'nl' => 'rtl'], 'nimblybar' => ['side' => ['en' => 'right', 'nl' => 'left']]];
site_settings_validation_assert(site_settings_validate_config('.config', 'site', $kept) && $kept['direction']['nl'] === 'rtl' && $kept['nimblybar']['side']['en'] === 'right', 'Chosen direction or sidebar side was overwritten.');
$bad_direction = ['languages' => ['en', 'nl'], 'direction' => ['en' => 'up']];
