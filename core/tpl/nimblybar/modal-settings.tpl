      ...
      <div class="relative overflow-y-auto px-4 py-2 pb-0">
        <form autocomplete="false" class="mt-2">
          ...
          <div class="relative my-6">
            ...
            <label for="page_title" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] -translate-y-1/2 truncate bg-white px-1 text-sm leading-tight text-neutral-600">
              [#text Page title#]
            </label>
          </div>
