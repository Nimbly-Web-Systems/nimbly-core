      ...
      <div class="relative overflow-y-auto px-4 py-2 pb-0">
        <form autocomplete="false" class="mt-2">
          ...
          <div class="relative my-6">
            ...
            <label for="page_title" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] -translate-y-[1.15rem] scale-[0.8] truncate bg-white px-1 pt-[0.37rem] leading-[2.15] text-neutral-600 transition-all duration-200 ease-out peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-neutral-900 motion-reduce:transition-none">
              [#text Page title#]
            </label>
          </div>
