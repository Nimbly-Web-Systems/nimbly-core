<form x-data="site_settings([#_ss.name_json#], [#_ss.description_json#], [#_ss.side_json#], [#_ss.language_rows_json#], [#_ss.language_catalog_json#], [#_ss.features_json#])" @submit.prevent="submit" class="max-w-2xl divide-y divide-neutral-200">
    <div class="pb-5">
    ...
    <div class="py-5">
        ...
        <p class="mb-3 text-sm text-neutral-500">[#text Visitors get their own language when available, otherwise the default.#]</p>
    ...
    <div class="py-5">
        ...
        <p class="mt-1 text-xs text-neutral-500">[#text Set per language, so right-to-left scripts can show it on the right side.#]</p>
    </div>
