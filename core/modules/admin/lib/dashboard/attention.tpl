<section x-show="attention_visible" x-cloak
    ...
    <ul class="space-y-3 text-sm text-amber-900">
        <li x-show="maintenance_unhealthy" x-cloak>
            <div class="font-medium">[#text Required maintenance has failed or is overdue#]</div>
            <div>[#text Check the project scheduler before relying on background email or session cleanup#]</div>
        </li>
