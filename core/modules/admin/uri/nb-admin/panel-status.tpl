<div class="flex flex-col flex-auto p-6 bg-neutral-50 shadow rounded-2xl overflow-visible" x-data="fmt_bytes">
    <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end [#feature-cond manage-system echo_else=hidden#]">
            ...
            <ul tabindex="0" class="dropdown-content z-[1000] m-0 min-w-max list-none overflow-hidden rounded-lg border-none bg-emerald-700 bg-clip-padding text-left text-base shadow-lg">
                <li>
