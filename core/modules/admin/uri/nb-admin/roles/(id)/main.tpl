[#get-resource-record roles [#role-id#]#]
...
<section class="bg-neutral-100 p-2 sm:p-4 md:p-6 lg:p-8 font-primary">
    <nav class="mb-2 flex items-center gap-1.5 text-xs font-medium text-neutral-500" aria-label="Breadcrumb">
        ...
        <span aria-hidden="true">/</span>
        <span class="text-neutral-700">[#get record.name default=[#role-id#]#]</span>
    </nav>
    <h1 class="mb-4 text-2xl md:text-3xl font-semibold text-neutral-800">[#text Edit role#]</h1>
    [#resource-switcher roles [#role-id#]#]
</section>
