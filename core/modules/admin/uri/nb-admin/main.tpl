...
<section class="bg-neutral-100 px-4 sm:px-6 md:px-8 lg:px-10 py-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
        <div class="flex flex-col flex-auto p-6 bg-neutral-50 shadow rounded-2xl overflow-hidden">
            ...
            <div class="text-7xl text-cnormal font-bold text-center mt-4">
                [data-count users]
            </div>
        ...
        <div class="flex flex-col flex-auto p-6 py bg-neutral-50 shadow rounded-2xl overflow-hidden">
            <div class="text-lg font-lato font-medium truncate">
                [text Last update]
            </div>
            [ago [last-update]]
        </div>
