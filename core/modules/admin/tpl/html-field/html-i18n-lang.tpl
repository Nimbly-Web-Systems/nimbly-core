<div class="relative my-6" x-show="lang == '[#lang_code.key#]'">
    <div data-nb-edit="[#item.key#].[#lang_code.key#]" 
        data-nb-edit-options='{
            ...
            class="prose">
        [#get-html record.[#item.key#].[#lang_code.key#] legacy-img-sizes=lg-70,xl-50#]
    </div>
