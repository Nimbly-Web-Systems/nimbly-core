  ...
  <div class="rounded-t-lg border border-neutral-200 bg-neutral-50 text-neutral-600">
    <h2 class="mb-0" id="heading_vimeo">
      <button
        ...
        type="button" data-te-collapse-init data-te-target="#vimeo_id" aria-expanded="true" aria-controls="vimeo_id">
    ...
    <div id="vimeo_id" class="!visible" data-te-collapse-item data-te-collapse-show aria-labelledby="heading_vimeo"
      ...
      <div class="px-5 py-4">
        ...
        <div class="relative max-w-xs " data-te-input-wrapper-init>
          <input type="text" value="" name="vimeo_id" placeholder=""
            xxx-init="form_data.[#item.key#]='[#get record.[#item.key#]#]'" xxx-model="form_data.[#item.key#]" class="
  ...
  <div class="border border-t-0 border-neutral-200 bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-800">
    ...
    <div id="youtube_id" class="!visible hidden" data-te-collapse-item aria-labelledby="heading_youtube"
      ...
      <div class="px-5 py-4">
        ...
        <div class="relative max-w-xs" data-te-input-wrapper-init>
          <input type="text" value="" name="youtube_id" placeholder=""
            xxx-init="form_data.[#item.key#]='[#get record.[#item.key#]#]'" xxx-model="form_data.[#item.key#]" class="
                  peer block min-h-[auto] w-full rounded border-0 bg-transparent px-2 py-[0.2rem] 
                  leading-[2.15] outline-none transition-all duration-200 ease-linear 
                  focus:placeholder:opacity-100 
