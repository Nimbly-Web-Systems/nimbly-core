<h2>[#get site_name#]: [#text Fatal PHP error#]</h2>
...
<table cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
    ...
    <tr><td><strong>[#text Line#]</strong></td><td>[#get fatal_line#]</td></tr>
    <tr><td><strong>[#text URL#]</strong></td><td>[#get fatal_url#]</td></tr>
    <tr><td><strong>[#text Signature#]</strong></td><td>[#get fatal_signature#]</td></tr>
</table>
