...
function command_label(name) {
  const labels = {
    ...
    'schedule:init': 'Init schedule',
    'schedule:publish': 'Init schedule',
    'scheduler:install': 'Install scheduler',
    'scheduler:project:add': 'Add scheduler project',
    'scheduler:project:remove': 'Remove scheduler project',
    'scheduler:project:list': 'List scheduler projects',
    'scheduler:add-project': 'Add scheduler project',
    'scheduler:remove-project': 'Remove scheduler project',
    'scheduler:list-projects': 'List scheduler projects',
    'scheduler:run': 'Run scheduler',
    'scheduler:cron:install': 'Install scheduler cron',
    'scheduler:cron:remove': 'Remove scheduler cron',
    'scheduler:cron:status': 'Scheduler cron status',
    'routes:sync': 'Sync routes',
